...
@section('css')
    ...
    <style>
        ...
        .test-drive-section{padding: 50px 0px;background-color: #8b91a3;}
...
@section('body')
            ...
            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link fw-semibold active position-relative" id="pills-home-tab"
                        ...
                        aria-controls="pills-home" aria-selected="true">SUV</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link fw-semibold position-relative" id="pills-profile-tab"
                        data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab"
                        aria-controls="pills-profile" aria-selected="false">Sedan</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link fw-semibold position-relative" id="pills-contact-tab"
                        data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab"
                        aria-controls="pills-contact" aria-selected="false">Hatchback</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link fw-semibold position-relative" id="pills-electric-tab"
                            data-bs-toggle="pill" data-bs-target="#pills-electric" type="button" role="tab"
                            aria-controls="pills-electric" aria-selected="false">Electric</button>
                </li>
            </ul>
    ...
    <section class="test-drive-section">
        <div class="container">
            <div class="row">
                <div class="col">
                    <a href="#" class="btn btn-drive">Request a Test Drive</a>
                </div>
                <div class="col">
                    <a href="#" class="btn btn-drive">Download E-Brochure</a>
                </div>
                <div class="col">
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="contact-img">
                            <img src="https://live.themewild.com/taxica/assets/img/contact/01.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 align-self-center">
